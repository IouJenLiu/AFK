...
def main():
    ...
    if args.hint:
        print("Sol.:", ". ".join(game_state["extra.walkthrough"]))
    ...
    for i in range(args.max_steps) if args.max_steps > 0 else itertools.count():
    ...
    env.close()
    print("Done after {} steps. Score {}/{}.".format(i+1, game_state.score, game_state.max_score))
